...
def set_front_ptr(queue, value):
    queue.set_front_ptr(value)
    
def set_rear_ptr(queue, value):
    queue.set_rear_ptr(value)
...
class Queue:
    ...
    def __init__(self, start = "()", end = "()"):
        self.front_ptr = [start, end]
        self.rear_ptr = end
        
    def is_empty(self):
        return self.front_ptr[0] == "()" and self.front_ptr[1] == "()"
        
    def set_front_ptr(self, value):
        self.front_ptr.append(value)
        
    def set_rear_ptr(self, value):
        self.rear_ptr = value
        
    def insert_queue(self, item):
        if empty_queue(self):
            set_front_ptr(self, item)
            set_rear_ptr(self, item)
        else:
            set_front_ptr(self, item)
            set_rear_ptr(self, item)
        return self
    ...
    def delete_queue(self):
        self.front_ptr.pop(0)
        
    def __str__(self):
        return "head: {}, tail: {}".format(self.rear_ptr, self.front_ptr)
