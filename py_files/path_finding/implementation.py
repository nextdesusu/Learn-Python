...
'''
came_from, cost_so_far = a_star_search(diagram4, (1, 4), (1, 1))
...
def search(graph, start, goal):
    ...
    path.reverse()
    return path
map_ = [["lol" if i == 3 and j == 3 else "kek" for i in range(6)] for j in range(6)]
#for elem in map_:
#    print(elem)
graph = SquareGrid(6, 6)
print(search(graph, (0, 0), (5, 5)))